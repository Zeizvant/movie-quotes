...
<div class="h-20 rounded border-4 flex items-center justify-between px-3">
    ...
    @endif
    <p class="text-lg h-full flex justify-center items-center px-2 w-1/3 lg:w-1/2 overflow-y-scroll p-2">{!! $link === 'quote' ? $body->getTranslation('body', app()->getLocale()) : $body->getTranslation('name', app()->getLocale()) !!}</p>
